...
\subsection{Codifica delle Gerarchie (Ereditarietà)}
...
\subsubsection*{1. Partizionamento Orizzontale (Accorpamento verso il basso)}
...
\subsubsection*{2. Partizionamento Singolo (Accorpamento verso l'alto)}
...
\subsubsection*{3. Partizionamento Verticale (Traduzione in Associazioni 1:1)}
