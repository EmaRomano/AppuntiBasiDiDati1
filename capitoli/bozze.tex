...
% Il criterio di raggruppamento è determinato da una lista (eventualmente vuota) di attributi. Nel nostro caso un solo attributo, matricola --> corrisponde alla relazione di equivalenza "avere la stessa matricola". Più in generale, se gli attributi sono n, la relazione diventa avere la stessa n-pla di valori su quegli attributi. In caso di lista vuota, il raggruppamento è unico. 
