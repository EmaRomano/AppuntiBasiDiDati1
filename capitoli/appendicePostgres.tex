...
Se la connessione al database è già aperta e la sessione interattiva è attiva, si utilizza il meta-comando \texttt{\textbackslash i} (include).

\begin{lstlisting}[language=PostgreSQL, title=Esecuzione interattiva di un file SQL]
-- Esegue lo script indicando il percorso (assoluto o relativo)
\i /home/utente/progetti/ecommerce/init_schema.sql
\end{lstlisting}
